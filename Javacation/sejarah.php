...
<body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM tempat_wisata where id_kat=7";
    ...
    ?>
        <div class="grid-container-act">
            ...
            ?>
                <div class="grid-item">
                    <a href="transaksi.php?view=<?php echo $data['id_tw']; ?>"><img src="/Javacation/foto_tempat_wisata/foto_sejarah/<?php echo $data['foto']; ?>" alt="" width="333" height="186"></a>
